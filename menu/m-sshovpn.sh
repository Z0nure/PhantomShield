...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Zonure/authpremium/main/auth > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Zonure/authpremium/main/auth | grep $MYIP | awk '{print $2}')
